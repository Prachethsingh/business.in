      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          <div>
            ...
            <p className="mt-3 text-sm sm:text-base font-sans text-slate-300 leading-relaxed">
          ...
          <div className="rounded-2xl bg-[#121212] border border-white/15 p-6 shadow-2xl space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center text-xs font-mono mb-3">
                <span className="text-slate-300 font-semibold">12-Month Revenue Growth Ramp</span>
            ...
            <div className="grid grid-cols-3 gap-2.5 pt-1">
              <div className="p-3 rounded-xl bg-white/[0.03] border border-white/10 space-y-1">
                ...
                <p className="text-xs font-bold font-mono text-white m-0">₹1.45L<span className="text-[10px] text-slate-400">/mo</span></p>
                <span className="text-[10px] text-slate-400 font-mono">Break-even: 34m</span>
              </div>
              <div className="p-3 rounded-xl bg-[#00FF85]/[0.06] border border-[#00FF85]/30 space-y-1">
                ...
                <p className="text-xs font-bold font-mono text-[#00FF85] m-0">₹2.45L<span className="text-[10px] text-slate-400">/mo</span></p>
                <span className="text-[10px] text-slate-300 font-mono font-semibold">Break-even: 21m</span>
              </div>
              <div className="p-3 rounded-xl bg-white/[0.03] border border-white/10 space-y-1">
                <span className="text-[10px] font-mono uppercase text-[#38BDF8] font-semibold">90th % (Best)</span>
                <p className="text-xs font-bold font-mono text-white m-0">₹3.60L<span className="text-[10px] text-slate-400">/mo</span></p>
                <span className="text-[10px] text-slate-400 font-mono">Break-even: 14m</span>
              </div>
            </div>
